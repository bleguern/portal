...
<script language="c#" runat="server">
	/// <summary>
	/// Class used for FTP data exchange
	/// </summary>
	public class MarieFtpClient
	{

		/// <summary>
		/// Devired class for FTP Exception
		/// </summary>
		...
		public MarieFtpClient(string server, string username, string password)
		{
			this.server = server;
		...
		public MarieFtpClient(string server, string username, string password, int timeoutSeconds, int port)
		{
			this.server = server;
			this.username = username;
			this.password = password;
		...
		/// </summary>
		/// <param name="remFileName">File name to download</param>
		...
		/// </summary>
		/// <param name="remFileName">File name</param>
		/// <param name="locFileName">File location (must exist)</param>
		...
		/// <param name="newFileName">Renamed file name</param>
