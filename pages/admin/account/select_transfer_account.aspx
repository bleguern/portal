...
<html>
<head>
<title>ADMINISTRATION - Select an account to transfer</title>
...
<script language="C#" runat="server">
	...
	void TransferAccountButton_Click(Object sender, EventArgs e) {
		...
		{
			Response.Redirect("transfer_account.aspx?account_id=" + AccountSelect.Value);
		}
	}
</script>
<body>
...
<table width="500" border="0" cellspacing="0" cellpadding="0">
  <tr>
  	<td>
		<table width="500" border="0" cellspacing="0" cellpadding="0">
			<tr>
    			<td class="header">SELECT AN ACCOUNT TO TRANSFER</td>
  			</tr>
		</table>
	</td>
  <tr>
