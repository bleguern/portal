...
<html>
<head>
<title>ADMINISTRATION - Update a contract</title>
...
<script language="C#" runat="server">
	void Page_Load(Object sender, EventArgs e) 
	{
		if(!IsPostBack)
		{
			string contractId = Request["contract_id"];
			...
			if(!contractId.Equals(""))
			{
				if(Session["sql_connection_string"] != null)
				{
					...
					string [] values = sqlClient.GetValuesWithStoredProcedure("admin_get_contract",
						"@id_support", contractId);
				
					SetHmltSelectSelectedIndexByString(ref ProjectSelect, values[0]);
					SetHmltSelectSelectedIndexByString(ref StatusSelect, values[1]);
					SetHmltSelectSelectedIndexByString(ref CommercialSelect, values[2]);
					SupportReferenceTextField.Value = values[3];
					SetHmltSelectSelectedIndexByString(ref TypeSelect, values[4]);
					OpeningDateTextField.Value = values[5];
					ClosingDateTextField.Value = values[6];
				}
			...
			if(!contractId.Equals(""))
			{
				if(Session["sql_connection_string"] != null)
				{
					try
					{
						...
						string result = sqlClient.ExecuteStoredProcedure("admin_update_contract",
							"@id_support", contractId,
					...
					{
						Response.Redirect("../../error/Default.aspx?error=Internal error while updating a contract!&message=" + ex.Message);
					}
				}
			}
		}
...
<table width="850" border="0" cellspacing="0" cellpadding="0">
  <tr>
  	<td>
		<table width="850" border="0" cellspacing="0" cellpadding="0">
			<tr>
    			<td class="header">UPDATE A CONTRACT</td>
  			</tr>
		</table>
	</td>
   </tr>
	  ...
	  <table width="850" border="0" cellspacing="0" cellpadding="0">
		<tr>
		 ...
		 <td width="100"><input type="submit" class="text" runat="server" style="width:100px" id="SaveContractButton" name="SaveContractButton" alt="Save contract" value="Save" onServerClick="SaveContractButton_Click"></td>
      	 <td width="600"><input type="submit" class="text" runat="server" style="width:100px" id="SetDefaultLevelButton" name="SetDefaultLevelButton" alt="Set default level list" value="Set default" onServerClick="SetDefaultLevelButton_Click"></td></tr>
	  </table>
	  </td>
    </tr>
	<tr>
