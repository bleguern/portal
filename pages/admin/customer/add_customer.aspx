...
<html>
<head>
<title>ADMINISTRATION - Add a customer</title>
		...
		else
		{
			if(Session["sql_connection_string"] != null)
			{
				try
				{
					...
					string result = sqlClient.ExecuteStoredProcedure("admin_add_customer",
				...
				{
					Response.Redirect("../../error/Default.aspx?error=Internal error while adding a customer!&message=" + ex.Message);
				}
			}
		}
	}
...
<table width="500" border="0" cellspacing="0" cellpadding="0">
  <tr>
  	<td>
		<table width="500" border="0" cellspacing="0" cellpadding="0">
			<tr>
    			<td class="header">ADD A CUSTOMER</td>
  			</tr>
		</table>
	</td>
   </tr>
