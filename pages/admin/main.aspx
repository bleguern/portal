...
<link href="../../css/main.css" rel="stylesheet" type="text/css">
	...
	<script language="C#" runat="server">
		...
		{
			InformationTextField.Value = "Welcome to Administration, you are connected as " + User.Identity.Name.ToUpper() + " on " + Session["server"].ToString();
		}
	</script>
<body>
<form id="MainForm" method="post" runat="server">
  ...
  <tr>
  	<td class="header">PORTAL ADMINISTRATION</td>
  </tr>
  <tr>
    <td height="10"></td>
  </tr>
