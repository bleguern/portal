...
<html>
<head>
<title>ADMINISTRATION - TROUBLE TICKET - Main</title>
<link href="../../../css/main.css" rel="stylesheet" type="text/css">
</head>
	<script language="C#" runat="server">
		void Page_Load(Object sender, EventArgs e) 
		{
			InformationTextField.Value = "Welcome to Administration - Trouble Ticket, you are connected as " + User.Identity.Name.ToUpper() + " on " + Session["server"].ToString();
		}
	</script>
<body>
<form id="MainForm" method="post" runat="server">
  ...
  <tr>
  	<td class="header">ADMINISTRATION - TROUBLE TICKET</td>
  </tr>
  <tr>
    <td height="10"></td>
  </tr>
