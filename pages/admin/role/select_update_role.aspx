...
<html>
<head>
<title>ADMINISTRATION - Select a role to update</title>
...
<script language="C#" runat="server">
	...
	void UpdateRoleButton_Click(Object sender, EventArgs e) {
		if(RoleSelect.SelectedIndex != 0)
		{
			Response.Redirect("update_role.aspx?role_id=" + RoleSelect.Value);
		}
	}
</script>
<body>
...
<table width="500" border="0" cellspacing="0" cellpadding="0">
  <tr>
  	<td>
		<table width="500" border="0" cellspacing="0" cellpadding="0">
			<tr>
    			<td class="header">SELECT A ROLE TO UPDATE</td>
  			</tr>
		</table>
	</td>
  <tr>
  ...
  <tr>
    ...
    <tr>
	  ...
	  <table width="500" border="0" cellspacing="0" cellpadding="0">
		<tr align="center">
      	 <td><input type="submit" class="text" runat="server" style="width:100px" id="UpdateRoleButton" name="UpdateRoleButton" alt="Update role" value="Update" onServerClick="UpdateRoleButton_Click"></td>
      	</tr>
	  </table>
	  </td>
    </tr>
