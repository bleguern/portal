...
<html>
<head>
<title>ADMINISTRATION - Select an user to update</title>
...
<script language="C#" runat="server">
	...
	void UpdateUserButton_Click(Object sender, EventArgs e) {
		if(UserSelect.SelectedIndex != 0)
		{
			Response.Redirect("update_user.aspx?user_id=" + UserSelect.Value);
		}
	}
</script>
<body>
...
<table width="500" border="0" cellspacing="0" cellpadding="0">
  <tr>
  	<td>
		<table width="500" border="0" cellspacing="0" cellpadding="0">
			<tr>
    			<td class="header">SELECT AN USER TO UPDATE</td>
  			</tr>
		</table>
	</td>
  <tr>
  ...
  <tr>
    ...
    <tr>
	  ...
	  <table width="500" border="0" cellspacing="0" cellpadding="0">
		<tr align="center">
      	 <td><input type="submit" class="text" runat="server" style="width:100px" id="UpdateUserButton" name="UpdateUserButton" alt="Update user" value="Update" onServerClick="UpdateUserButton_Click"></td>
      	</tr>
	  </table>
	  </td>
    </tr>
