...
<html>
<head>
<title>TIME REPORT - Manage account list</title>
...
<script language="C#" runat="server">
	...
	void AccountListDataGrid_Delete(Object sender, DataGridCommandEventArgs e)
    {
        ...
        if(Session["sql_connection_string"] != null)
		{
			try
			{
				...
				string result = sqlClient.ExecuteStoredProcedure("donezat_delete_account_from_user",
					"@login", User.Identity.Name.ToUpper(),
	...
	void UpdateWishedAccountListDataGrid()
    {
		if(Session["sql_connection_string"] != null)
		{
			...
			int number = sqlClient.UpdateDataGridWithStoredProcedure(ref WishedAccountListDataGrid, "donezat_select_not_account_list_with_user",
				"@login", User.Identity.Name.ToUpper(),
				"@id", GetId(),
	...
	void WishedAccountListDataGrid_Delete(Object sender, DataGridCommandEventArgs e)
    {
		...
		if(Session["sql_connection_string"] != null)
		{
			try
			{
				...
				string result = sqlClient.ExecuteStoredProcedure("donezat_add_account_to_user",
					"@login", User.Identity.Name.ToUpper(),
...
<table width="850" border="0" cellspacing="0" cellpadding="0">
  <tr>
  	<td>
		<table width="850" border="0" cellspacing="0" cellpadding="0">
			<tr>
    			<td class="header">MANAGE ACCOUNT LIST</td>
  			</tr>
		</table>
	</td>
   </tr>
