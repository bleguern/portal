...
<script language="C#" runat="server">
	...
	void ShowButton_Click(Object sender, EventArgs e) {
		...
		{
			WriteJavaScript("window.open('show_index_admin.aspx?user_id=" + UserSelect.Value + "&name=" + UserSelect.Items[UserSelect.SelectedIndex].Text + "')");
		}
	}
...
<table width="500" border="0" cellspacing="0" cellpadding="0">
  <tr>
  	<td>
		<table width="500" border="0" cellspacing="0" cellpadding="0">
			<tr>
    			<td class="header">SELECTION FOR TIME REPORT ADMINISTRATION</td>
  			</tr>
		</table>
	</td>
 </tr>
 ...
 <tr>
    ...
    <tr>
	  ...
	  <table width="500" border="0" cellspacing="0" cellpadding="0">
		<tr align="center">
      	 <td><input type="submit" class="text" runat="server" style="width:100px" id="ShowButton" name="ShowButton" alt="Admin time report for this user" value="Admin" onServerClick="ShowButton_Click"></td>
      	</tr>
	  </table>
	  </td>
    </tr>
