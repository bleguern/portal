...
<script language="C#" runat="server">
	void Page_Load(Object sender, EventArgs e) 
	{
		if(!IsPostBack)
		{
			if(Session["sql_connection_string"] != null)
			{
				...
				sqlClient.UpdateDataSetWithStoredProcedure(ref pageData, "donezat_use_report_page_data");
	...
	void ShowButton_Click(Object sender, EventArgs e) {
		...
		else
		{
			...
			{
				Response.Redirect("show_use_report.aspx?sector_id=" + SectorSelect.Value + 
...
<table width="500" border="0" cellspacing="0" cellpadding="0">
  <tr>
  	<td>
		<table width="500" border="0" cellspacing="0" cellpadding="0">
			<tr>
    			<td class="header">SELECTION FOR USE REPORT</td>
  			</tr>
		</table>
	</td>
 </tr>
  ...
  <tr>
	  <td>
		<table width="500" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="100" class="text" align="left">Division : </td>
			    <td width="5"></td>
			    <td width="100"><select id="SectorSelect" name="SectorSelect" size="1" class="text" style="width:100px"
