...
<html>
<head>
<title>EXPENSES - Manage account list</title>
...
<script language="C#" runat="server">
	void Page_Load(Object sender, EventArgs e) 
	{
		if(Session["sql_connection_string"] != null)
		{
			...
			sqlClient.UpdateDataSetWithStoredProcedure(ref pageData, "expenses_account_page_data");
	...
	void AccountListDataGrid_Delete(Object sender, DataGridCommandEventArgs e)
    {
        ...
        if(Session["sql_connection_string"] != null)
		{
			try
			{
				...
				string result = sqlClient.ExecuteStoredProcedure("expenses_delete_account_from_user",
					"@login", User.Identity.Name.ToUpper(),
	...
	void UpdateWishedAccountListDataGrid()
    {
		if(Session["sql_connection_string"] != null)
		{
			...
			int number = sqlClient.UpdateDataGridWithStoredProcedure(ref WishedAccountListDataGrid, "expenses_select_not_account_list_with_user",
				"@login", User.Identity.Name.ToUpper(),
				"@id", GetId(),
	...
	void WishedAccountListDataGrid_Delete(Object sender, DataGridCommandEventArgs e)
    {
		...
		if(Session["sql_connection_string"] != null)
		{
			try
			{
				...
				string result = sqlClient.ExecuteStoredProcedure("expenses_add_account_to_user",
					"@login", User.Identity.Name.ToUpper(),
