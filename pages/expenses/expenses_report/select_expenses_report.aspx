...
<script language="C#" runat="server">
	...
	void ShowCurrentButton_Click(Object sender, EventArgs e) {
		InformationTextField.Value = null;
		
		Response.Redirect("show_expenses_report.aspx?year=" + DateTime.Now.Year.ToString() + 
			"&begin_month=" + DateTime.Now.Month.ToString() +
			"&end_month=" + DateTime.Now.Month.ToString());
	}
	...
	void ShowButton_Click(Object sender, EventArgs e) {
		...
		{
			Response.Redirect("show_expenses_report.aspx?year=" + YearSelect.Value +
...
<tr>
  	<td>
		<table width="500" border="0" cellspacing="0" cellpadding="0">
			<tr>
    			<td class="header">SHOW CURRENT MONTH EXPENSES REPORT</td>
  			</tr>
		</table>
	</td>
 </tr>
  <tr>
    ...
    <tr>
	  <td align="center"><input value="Show" type="submit" class="text" id="ShowCurrentButton" name="ShowCurrentButton" onServerClick="ShowCurrentButton_Click" alt="Show last month report" style="width:100px" runat="server"/></td>
    </tr>
	<tr>
	 <td height="10"></td>
	</tr>
  <tr>
  	<td>
		<table width="500" border="0" cellspacing="0" cellpadding="0">
			<tr>
    			<td class="header">SELECTION FOR EXPENSES REPORT</td>
  			</tr>
		</table>
	</td>
 </tr>
  ...
  <tr>
    ...
    <tr>
	  <td align="center"><input value="Show" type="submit" class="text" id="ShowButton" name="ShowButton" onServerClick="ShowButton_Click" alt="Show report" style="width:100px" runat="server"/></td>
    </tr>
	<tr>
	 <td height="10"></td>
	</tr>
