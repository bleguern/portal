  ...
  <tr>
    ...
    >
      ...
      <Columns>
		...
		<asp:TemplateColumn HeaderText="NAME" HeaderStyle-Width="200">
          <ItemTemplate>
	...
	<tr>
	 <td align="center"><input name="CloseButton" class="text" type="button" id="CloseButton" value="Close" onClick="javascript:self.close()" alt="Close the window" style="width:100px" /></td>
	</tr>
</table>
</form>
</body>
